...
distribution), the CAD Viewer client, and every skill (the Skills CLI installs
...
class PackagedMarkdownShipsAlone(unittest.TestCase):
    ...
    def test_no_repo_relative_references(self) -> None:
        ...
        self.assertEqual(
            offenders,
            [],
            "Ships-alone law: cadgen installs from PyPI, the CAD Viewer "
            "client ships with cadgen, and skills "
