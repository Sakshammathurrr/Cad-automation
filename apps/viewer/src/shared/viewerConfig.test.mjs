...
test("normalizeViewerDiscordUrl defaults to the configured Discord URL", () => {
...
test("the agent update prompt names the skills command alone, in one short line", () => {
  assert.match(DEFAULT_VIEWER_SKILLS_UPDATE_PROMPT, /npx skills add sakshammathurrr\/text-to-cad/u);
